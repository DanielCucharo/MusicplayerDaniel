void keyPressedShortCuts() {
 ...
 //
  ...
  void quitButtonCode() {
   ...
   void fastRewind() {}//End Fast Rewind
   //
   void fastForward() {}//End Previous Song
   //
   void fastForward() {}//End Loop Song
   //
   void fastForward() {}//End Loop Playlist
   //
   void fastForward() {}//End Shuffle the Playlist()
   //
   void fastForward() {}//End LoopandShuffle
   //
